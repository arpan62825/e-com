    ...
    <div className="privacy-policy-page">
      <section className="privacy-hero">
        ...
        <p className="hero-sub">
          Protecting Your Privacy with the Same Care We Protect Our Planet
        </p>
      </section>
      ...
      <section className="privacy-content">
        <div className="policy-introduction">
          <p>
            At Ephemeral Clothing, we believe in transparency and respect for
            your privacy. This policy outlines our practices for collecting,
            using, and protecting your personal information. Last updated:
            February 2024.
          </p>
        </div>
